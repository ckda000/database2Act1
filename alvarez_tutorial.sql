...
-- Started on 2019-12-17 16:26:55
...
--
-- TOC entry 196 (class 1259 OID 1829169)
-- Name: activity; Type: TABLE; Schema: public; Owner: uljfnjlwcqkwfm
--
...
ALTER TABLE public.activity OWNER TO uljfnjlwcqkwfm;

--
-- TOC entry 3820 (class 0 OID 1829169)
-- Dependencies: 196
-- Data for Name: activity; Type: TABLE DATA; Schema: public; Owner: uljfnjlwcqkwfm
--

COPY public.activity ("staffNo", "tutorName", "tuteeNo", "tuteeName", date, "time", "tutorialNo") FROM stdin;
S1011	Mark Zuckerberg	T100	AGUJAR, CHRISSA MAE B.	2020-01-15	10.00	T10
S1223	Eldon Musk	T106	ALPAS, GREM RAY R.	2020-01-16	9.00	T01
...
-- Dependencies: 3
-- Name: SCHEMA public; Type: ACL; Schema: -; Owner: uljfnjlwcqkwfm
--

REVOKE ALL ON SCHEMA public FROM postgres;
REVOKE ALL ON SCHEMA public FROM PUBLIC;
GRANT ALL ON SCHEMA public TO uljfnjlwcqkwfm;
...
GRANT ALL ON LANGUAGE plpgsql TO uljfnjlwcqkwfm;


-- Completed on 2019-12-17 16:27:13
